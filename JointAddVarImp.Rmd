...
siml.corr <- siml.corr %>% 
  mutate(Y = 20*V1*V2+20*2^V5+err2)
...
joint.add.var.test1 <- joint_add_var_rf(data = siml.corr, pred.part = part1, 
                                      ntree1 = 500, ntree2 = 500, replace = FALSE)
joint.add.var.test2 <- joint_add_var_rf(data = siml.corr, pred.part = part2, 
                                      ntree1 = 500, ntree2 = 500, replace = FALSE)
joint.add.var.test3 <- joint_add_var_rf(data = siml.corr, pred.part = part3, 
                                      ntree1 = 500, ntree2 = 500, replace = FALSE)
joint.add.var.test4 <- joint_add_var_rf(data = siml.corr, pred.part = part4, 
                                      ntree1 = 500, ntree2 = 500, replace = FALSE)
joint.add.var.test5 <- joint_add_var_rf(data = siml.corr, pred.part = part5, 
                                      ntree1 = 500, ntree2 = 500, replace = FALSE)
joint.add.var.test6 <- joint_add_var_rf(data = siml.corr, pred.part = part6, 
                                      ntree1 = 500, ntree2 = 500, replace = FALSE)

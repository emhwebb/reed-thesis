...
javpi.ex.plots[[1]] <- javpi.ex.plots[[1]]+labs(y = "Where All of Signal is Contained in Partition")
javpi.ex.plots[[2]] <- javpi.ex.plots[[2]]+labs(y = "Where Signal is Split Between Partitions")
...
```{r echo = FALSE, warning = FALSE, fig.env = 'marginfigure', fig.cap= "\\label{siml1to5plots}JAVP for Simulations 1, 2, and 5, Respectively, for First Simulation Run"}
...
```{r results="asis", echo = FALSE, warning = FALSE, message = FALSE, fig.height = 8, fig.env = 'marginfigure', fig.cap= "\\label{MDAforJAVPI} MDA Simulation Results for JAVPI Simulated Datasets"}

...
perm_add_var_randomforest <- function(data, it, ntree1, ntree2, ntree3, replace = TRUE){
  ...
  rf.perm.add.var.list <- rf_perm_add_var(data.list = rf.add.var.list, 
                                          it = it, ntree3 = ntree3, replace = replace)
  list(add.var.imp, rf.add.var.list, rf.list[[2]], rf.perm.add.var)
}
...
siml1.wrep.results <- perm_add_var_randomforest(data = siml.data1, it = 1000, ntree1 = 1000, 
                                                ntree2 = 1000, ntree3 = 1000)
siml1.worep.results <- perm_add_var_randomforest(data = siml.data1, it = 1000, ntree1 = 1000, 
                                                 ntree2 = 1000, ntree3 = 1000, replace = FALSE)
siml2.wrep.results <- perm_add_var_randomforest(data = siml.data2, it = 1000, ntree1 = 1000, 
                                                ntree2 = 1000, ntree3 = 1000)
siml2.worep.results <- perm_add_var_randomforest(data = siml.data2, it = 1000, ntree1 = 1000, 
                                                 ntree2 = 1000, ntree3 = 1000, replace = FALSE)
...
siml3.wrep.results <- perm_add_var_randomforest(data = siml.data3, it = 1000, ntree1 = 1000, 
                                                ntree2 = 1000, ntree3 = 1000)
siml3.worep.results <- perm_add_var_randomforest(data = siml.data3, it = 1000, ntree1 = 1000, 
                                                 ntree2 = 1000, ntree3 = 1000, replace = FALSE)
siml4.wrep.results <- perm_add_var_randomforest(data = siml.data4, it = 1000, ntree1 = 1000, 
                                                ntree2 = 1000, ntree3 = 1000)
siml4.worep.results <- perm_add_var_randomforest(data = siml.data4, it = 1000, ntree1 = 1000, 
                                                 ntree2 = 1000, ntree3 = 1000, replace = FALSE)
...
siml5.wrep.results <- perm_add_var_randomforest(data = siml.data5, it = 1000, ntree1 = 1000, 
                                                ntree2 = 1000, ntree3 = 1000)
siml5.worep.results <- perm_add_var_randomforest(data = siml.data5, it = 1000, ntree1 = 1000, 
                                                 ntree2 = 1000, ntree3 = 1000, replace = FALSE)
siml6.wrep.results <- perm_add_var_randomforest(data = siml.data6, it = 1000, ntree1 = 1000, 
                                                ntree2 = 1000, ntree3 = 1000)
siml6.worep.results <- perm_add_var_randomforest(data = siml.data6, it = 1000, ntree1 = 1000, 
                                                 ntree2 = 1000, ntree3 = 1000, replace = FALSE)
...
siml7.wrep.results <- perm_add_var_randomforest(data = siml.data7, it = 1000, ntree1 = 1000, 
                                                ntree2 = 1000, ntree3 = 1000)
siml7.worep.results <- perm_add_var_randomforest(data = siml.data7, it = 1000, ntree1 = 1000, 
                                                 ntree2 = 1000, ntree3 = 1000, replace = FALSE)
siml8.wrep.results <- perm_add_var_randomforest(data = siml.data8, it = 1000, ntree1 = 1000, 
                                                ntree2 = 1000, ntree3 = 1000)
siml8.worep.results <- perm_add_var_randomforest(data = siml.data8, it = 1000, ntree1 = 1000, 
                                                 ntree2 = 1000, ntree3 = 1000, replace = FALSE)
...
#independent non-linear interactions
n9 <- 2000
p9 <- 12
err9 <- rnorm(n9, mean = 0, sd = 0.05)
siml.data9 <- as.data.frame(matrix(rnorm(n9*p9, mean = 0, sd = 1), nrow = n9))
siml.data9 <- siml.data9 %>%
  mutate(Y = 5*V1^V2+5*V5^V6+err9)


#Correlated  non-linear interactions 
n20 <- 2000
err20 <- rnorm(n10, mean = 0 , sd = 0.05)
siml.data10 <- as.data.frame(rmvnorm(n = n10, mean = rep(0, times = 12), sigma = Sigma2))
siml.data10 <- siml.data10 %>%
  mutate(Y = 5*V1^V2+5*V5^V6+err10)

```

```{r}

siml9.wrep.results <- perm_add_var_randomforest(data = siml.data9, it = 1000, ntree1 = 1000, 
                                                ntree2 = 1000, ntree3 = 1000)
siml9.worep.results <- perm_add_var_randomforest(data = siml.data9, it = 1000, ntree1 = 1000, 
                                                 ntree2 = 1000, ntree3 = 1000, replace = FALSE)
siml10.wrep.results <- perm_add_var_randomforest(data = siml.data10, it = 1000, ntree1 = 1000, 
                                                ntree2 = 1000, ntree3 = 1000)
siml10.worep.results <- perm_add_var_randomforest(data = siml.data10, it = 1000, ntree1 = 1000, 
                                                 ntree2 = 1000, ntree3 = 1000, replace = FALSE)
...
#independent non-linear interactions
#with sampling with replacement
siml9.wrep.results[[1]]
siml9.wrep.results[[3]]
rf_added_var_plot(siml9.wrep.results)
rf_plot_var_imp(siml9.wrep.results)
...
#independent non-linear interactions 
#with sampling without replacement
siml9.worep.results[[1]]
siml9.worep.results[[3]]
rf_added_var_plot(siml9.worep.results)
rf_plot_var_imp(siml9.worep.results)
...
#correlated non-linear interactions 
#with sampling with replacement
siml10.wrep.results[[1]]
siml10.wrep.results[[3]]
rf_added_var_plot(siml10.wrep.results)
rf_plot_var_imp(siml10.wrep.results)
...
#correlated non-linear interactions 
#with sampling without replacement
siml10.worep.results[[1]]
siml10.worep.results[[1]]
rf_added_var_plot(siml10.worep.results)
rf_plot_var_imp(siml10.worep.results)
